...
public class ListProductbyCategoryController extends HttpServlet {
	...
	/*	String idcate = req.getParameter("id");
		List<Product> productes = productService.searchbycategoryid(Integer.parseInt(idcate));
		...
		*/
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/view/client/listproductbycategory.jsp");
