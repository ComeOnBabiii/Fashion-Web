 ...
 * 
 * import com.fashion.model.User; import com.fashion.service.UserService; import
 * com.fashion.service.impl.UserServiceImpl;
 * 
 * @WebServlet(urlPatterns = { "/admin/user/add" }) public class
 * UserAddController extends HttpServlet { UserService userService = new
 * UserServiceImpl();
 * 
 * @Override protected void doGet(HttpServletRequest req, HttpServletResponse
 * resp) throws ServletException, IOException { String eString =
 * req.getParameter("e"); if (eString != null) { if (eString.equals("1")) {
 * req.setAttribute("errMsg", "Username da ton tai!!!"); } } RequestDispatcher
 * dispatcher = req.getRequestDispatcher("/view/admin/user/add-user.jsp");
 ...
 * user.setName(item.getString()); } else if
 ...
 * (item.getFieldName().equals("rollAdmin")) {
 * user.setRollAdmin(item.getString()); } else if
 * (item.getFieldName().equals("avatar")) { final String dir =
 * "C:/Users/Administrator/Downloads/WebDemo/WebDemo/WebContent/static/admin/images";
