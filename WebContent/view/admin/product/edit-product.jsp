			...
			<div class="mother-grid-inner">
				...
				<div class="inner-block">
					...
					<div class="signup-block bg">
						...
						<c:url value="/admin/product/edit" var="editPro"></c:url>
						<form action="${editPro}" method="post" id="ha" enctype="multipart/form-data">
							...
							<img height="150" src='<c:url value="/image?fname=${product.image }"/>'/>
							<p><br></p>
							<label for="exampleInputUsername">Category</label> 
							<select name="cate" value="">
