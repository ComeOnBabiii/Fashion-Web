									...
									<tbody>
										<c:forEach items="${userList}" var="u">
											<tr>
												...
												<td>${u.username }</td>
												<td>${u.password }</td>
												<c:url value="/image?fname=${u.avatar }" var="imgUrl"></c:url>
												<td><img height="150" src="${imgUrl}"/></td>
												<td>
												<a href="<c:url value='/admin/user/edit?id=${u.id }'/>" class="hvr-grow label label-warning">Edit</a> 
												<a href="<c:url value='/admin/user/delete?id=${u.id }'/>" class="hvr-grow label label-info">Delete</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
