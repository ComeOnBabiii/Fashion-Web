				...
				<div class="inner-block">
					...
					<div class="chit-chat-layer1 bg">
						<div class="work-progres">
							<div class="chit-chat-heading">List Cart</div>
									...
									<tbody>
										<c:forEach items="${sessionScope.cart}" var="map">
											<tr>
												...
												<td>
												<a href="<c:url value='/admin/cart/delete?pId=${map.key }'/>" class="hvr-grow label label-info">Delete</a>
												<a href="<c:url value='/admin/order?userId=${sessionScope.user.id}'/>" class="hvr-grow label label-info">Order</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
