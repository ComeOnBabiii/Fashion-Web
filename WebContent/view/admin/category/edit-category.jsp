			...
			<div class="mother-grid-inner">
				...
				<div class="inner-block">
					...
					<div class="signup-block bg">
						<h2 id="ha">Edit Category</h2>
						<c:url value="/admin/category/edit" var="editCate"></c:url>
						<form action="${editCate}" method="post" id="ha">
							<input type="text" readonly="readonly"
								name="id" value="${category.id }">
							
							<label>Name</label> <input type="text"
								name="name" placeholder="Name" required="" value="${category.name }">
								 
							 <label>Descreption</label>
							 <textarea type="text" name="des" required="" rows="5" cols="48">${category.descreption }</textarea>
