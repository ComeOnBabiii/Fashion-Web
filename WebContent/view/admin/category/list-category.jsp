									...
									<tbody>
										<c:forEach items="${cateList}" var="c">
											<tr>
												...
												<td>${c.descreption }</td>
												<td>
												<a href="<c:url value='/admin/category/edit?id=${c.id }'/>" class="hvr-grow label label-warning">Edit</a> 
												<a href="<c:url value='/admin/category/delete?id=${c.id }'/>" class="hvr-grow label label-info">Delete</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
