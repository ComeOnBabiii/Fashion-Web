				...
				<div class="inner-block">
					...
					<div class="signup-block bg">
						...
						<form action="${addCate}" method="post" id="ha">
							...
							<label for="exampleInputUsername">Descreption</label> 
							<textarea name="des" placeholder="Descreption" required="" rows="5" cols="48"></textarea>
							<br>
							<input type="submit" name="addCate" value="Submit"> </br>
						</form>
					</div>
				</div>
